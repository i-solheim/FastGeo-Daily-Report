            ...
            <div className="border rounded-lg overflow-hidden min-w-[700px]">
                ...
                {Object.keys(changes)
                    ...
                    .map(author => {
                        ...
                        return (
                            <div key={author} className="grid grid-cols-[180px_1fr] border-t">
                                <div
                                                            ...
                                                            <div className="flex flex-col">
                                                                {authorData[cat].map(issue => (
                                                                    <div
                                                                        ...
                                                                        className="grid grid-cols-[100px_1fr_180px_48px_24px] items-start gap-3 text-sm border-b last:border-b-0 py-4"
                                                                    >
                                                                        <a href={issue.issueUrl} target="_blank" rel="noreferrer"
                                                                            className="text-blue-600 hover:underline pl-4">
                                                                            {issue.issueKey}
                                                                        </a>
                                                                        <span className="min-w-0">{issue.issueTitle}</span>
